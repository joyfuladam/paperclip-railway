...
# hermes-agent is installed at first boot into /paperclip/hermes-venv (persistent volume)
# to avoid heavy pip compilation during Docker build. See entrypoint.sh.
